...
class MatchQuery {
    ...
    async run(limit, req, isRequest, id) {
	    ...
	    console.log('running python');
            var py    = await spawn('python', ['/home/vanshika/nob-server/tools/get_matches.py']),
        ...
        var spawn = require('child_process').spawn;
        var py    = await spawn('python', ['/home/vanshika/nob-server/tools/get_matches_delivery.py']),
            data = [req, dataArr, histories],
            dataString = '';
	...
	console.log('Wrote data in to script');
