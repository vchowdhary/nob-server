        ...
        router.get(
            ...
            async function(req, res) {
                ...
                if ('request' in req.query) {
                    ...
                    {
                        match.matchIDs = v;
                        const notif = await models.MatchNotification.create({matches: match.matchIDs, matchID: req.query.matchID, message: reqobj.user + ' is requesting your help with ' + reqobj.type + ': ' + reqobj.subject_1 + ', ' + reqobj.subject_2 + ', ' + reqobj.subject_3 + '\nDetails:' + reqobj.details + '\nLocation:' + reqobj.location.lat + ', ' + reqobj.location.lng})
                        ...
                        messages.push({
                            to: token.token,
                            sound: 'default',
                            data: {attempt: 1, match_notif_id: notif.id, req: reqobj, from_id: reqobj.requester_id, to_id: match.matchIDs[0], type: 'match_request', message: reqobj.user + ' is requesting your help with ' + reqobj.type + ': ' + reqobj.subject_1 + ', ' + reqobj.subject_2 + ', ' + reqobj.subject_3 + '\nDetails:' + reqobj.details + '\nLocation:' + reqobj.location.lat + ', ' + reqobj.location.lng}
                        });
