...
function configUsers(app, cookieSecret) {
    ...
    const statuses = new StatusManager(models.sequelize);
...
async function serve(config) {
    ...
    console.log('Configuring static paths');
